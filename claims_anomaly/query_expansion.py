"""
CLAIMS ANOMALY AGENT - deterministic query expansion for policy search.

NOTE: this is the THIRD deliberate copy of this file (claims_agent/ and
claims_agent_langgraph/ have the others). Each pipeline stays independently
readable, so none can break another. The cost is real and worth saying out
loud: a drug added here must be added in all three.
